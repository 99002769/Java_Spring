...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMissingPathVariable(MissingPathVariableException ex, HttpHeaders headers,
        ...
        LocalDateTime timeStamp  = LocalDateTime.now();
        List<String> details =
                Arrays.asList("Wrong MissingVarible","Not supported");
        APIErrors errors =
          new APIErrors(message, timeStamp, status, details);
        return ResponseEntity.status(status).body(errors);
	}
	...
	protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers,
        ...
        LocalDateTime timeStamp  = LocalDateTime.now();
        List<String> details =
                Arrays.asList("Wrong TypeMismatch","Not supported");
        APIErrors errors =
          new APIErrors(message, timeStamp, status, details);
        return ResponseEntity.status(status).body(errors);
	}
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
        ...
        LocalDateTime timeStamp  = LocalDateTime.now();
        List<String> details =
                Arrays.asList("Wrong Type Not Supported","Not supported");
        APIErrors errors =
          new APIErrors(message, timeStamp, status, details);
        return ResponseEntity.status(status).body(errors);
	}
	...
	protected ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
        ...
        LocalDateTime timeStamp  = LocalDateTime.now();
        List<String> details =
                Arrays.asList("Wrong MissingServlet","Not supported");
        APIErrors errors =
          new APIErrors(message, timeStamp, status, details);
        return ResponseEntity.status(status).body(errors);
	}
	...
	protected ResponseEntity<Object>
				handleBookException(Exception ex)
				{
					String message = ex.getMessage();
					LocalDateTime timeStamp  = LocalDateTime.now();
			        List<String> details =
