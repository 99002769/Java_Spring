...
public class BookResponseController {
	...
	ResponseEntity<Book> getBooksById(@PathVariable("bookId")Integer bookid)throws BookNotFoundException
	{
    ...
    public ResponseEntity<List<Book>> findByTitleAndAuthor(@PathVariable("title")String title,
            @PathVariable("author")String author) throws BookNotFoundException {
    ...
    public ResponseEntity<List<Book>> findBooksByTitleAndPrice(@PathVariable("title")String title, 
            @PathVariable("price")double price) throws BookNotFoundException {
